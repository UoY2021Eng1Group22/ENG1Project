 ...
 */
class ScrollingBackgroundAdapter implements JsonSerializer<ScrollingBackground>, JsonDeserializer<ScrollingBackground> {

    @Override
    public ScrollingBackground deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    ...
    @Override
    public JsonElement serialize(ScrollingBackground src, Type typeOfSrc, JsonSerializationContext context) {

...
public class DifficultySelectScreen implements Screen {
  ...
  public DifficultySelectScreen(DragonBoatRace game, String type) {
    ...
    this.easyButton =
        new Button(new Vector2(spacing, 100), "easy_button_active.png", "easy_button_inactive.png");
    this.mediumButton =
        new Button(new Vector2(spacing + (buttonWidth + spacing), 100), "medium_button_active.png",
            "medium_button_inactive.png");
    this.hardButton = new Button(new Vector2(spacing + (buttonWidth + spacing) * 2, 100),
        "hard_button_active.png", "hard_button_inactive.png");
  ...
  public void render(float delta) {
    ...
    font.draw(this.game.getBatch(), "Choose your Difficulty:",

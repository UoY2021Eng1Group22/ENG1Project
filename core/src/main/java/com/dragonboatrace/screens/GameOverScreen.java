...
public class GameOverScreen implements Screen {
  ...
  public void render(float delta) {
    ...
    font.draw(this.game.getBatch(), "GAME OVER!", (Gdx.graphics.getWidth() - layout.width) / 2,
        Gdx.graphics.getHeight() - 100 / Settings.SCALAR);
    ...
    font.draw(this.game.getBatch(), "Press Esc to return to Main Menu",
        (Gdx.graphics.getWidth() - layout.width) / 2, 200 / Settings.SCALAR);
